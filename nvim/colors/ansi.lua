...
local function define()
  ...
  vim.api.nvim_set_hl(0, "CursorLine", { ctermfg = 0, ctermbg = 15 })
  ...
  vim.api.nvim_set_hl(0, "CurSearch", { ctermbg = 3, ctermfg = 1 })
  ...
  -- markdown
  vim.api.nvim_set_hl(0, "@markup.heading.1", { ctermfg = 4, standout = true })
  vim.api.nvim_set_hl(0, "@markup.heading.2", { ctermfg = 4, bold = true, underline = true })
  vim.api.nvim_set_hl(0, "@markup.heading", { link = "Keyword" })

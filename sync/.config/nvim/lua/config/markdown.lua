  ...
  if begin_s then
    ...
    if end_s then
      ...
      if title then
        ...
        local entity = require "config.markdown_entity"
...
return {
  setup = function()
    ...
    --
    vim.api.nvim_create_user_command("GfPrefix", function(
        params ---@diagnostic disable-line: unused-local
    )
      vim.keymap.set("n", "gf", function()
        ...
        print('markdown', 'GfPrefix', dir, file)
  ...
  get_html_title = function()
    ...
    local link_destination, inline_link = get_link_destination(node)
